...
class Model:
    ...
    def __init__(self, config, embedding_pretrained, dropout_keep=1):
        ...
        self.embedding_size = config['embedding_size']      # vocabulary size
        self.embedding_dim = config['embedding_dim']        # word2vec dimension
        self.sen_len = config['sen_len']                    # max length for each sentence
